 ...
 *      
 * 
 * @example jQuery('table').tablesorter({ headers: { 0: {sorter:"integer"}, 1: {sorter:"currency"} } });
 * 
            ...
            function buildHeaders(table) {
                ...
                jQuerytableHeaders = jQuery(table.config.selectorHeaders, table).each(function (index) {
                    ...
                    if (!this.sortDisabled) {
                        ...
                        if (table.config.onRenderHeader) table.config.onRenderHeader.apply(jQueryth);
                    }
    ...
    ts.addWidget({
        ...
        format: function (table) {
            ...
            jQuery("tr:visible", table.tBodies[0]).each(function (i) {
                ...
                // row was styled
                if (!jQuerytr.hasClass(table.config.cssChildRow)) row++;
                odd = (row % 2 == 0);
